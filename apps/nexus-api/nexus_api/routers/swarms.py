...
class DispatchRequest(BaseModel):
    ...
    graph_type: str = Field(
        default="sequential",
        pattern=r"^(sequential|parallel|coding|research|crm|custom|deployment|puppeteer|meeting|billing|accounting|sales|intelligence|operations|campaign|calibration)$",
    )
